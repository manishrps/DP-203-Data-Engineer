...
4. In the **New dedicated SQL pool** page, enter **`SQLPool01`** (You <u>must</u> use this name exactly as displayed here) for the pool name, and then set the performance level to **DW100c** (move the slider all the way to the left).
...
8. **Continue on to Exercise 1** while this script is running.
    ...
    > ### **NOTE**: Potential errors that you can ignore
    >
